      ...
      <div className="success-page">
        ...
        <div className="success-container">
          ...
          <p className="success-description">
            Thank you for your interest! Your details are safe with us. If you
            ...
            >
              <Box display="flex" flexDirection="column" gap={3} maxWidth={400}>
                ...
                <FormLabel style={{ marginBottom: -12 }}>
                  Interested to join if we open in your society?
                </FormLabel>
                <RadioGroup
                  row
                ...
                <TextField
                  ...
                  onBlur={handleBlur}
                  error={
                    touched.alternatePhone && Boolean(errors.alternatePhone)
                  }
